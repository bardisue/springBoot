...
***/
      ...
      //  logger.info("description ->{0}", orderProperties.getDescription());
        ...
        ***/
        ...
        var voucherRepository = applicationContext.getBean(VoucherRepository.class); //BeanFactoryAnnotationUtils.qualifiedBeanOfType(applicationContext.getBeanFactory(), VoucherRepository.class, "memory");
       // var voucherRepository2 = BeanFactoryAnnotationUtils.qualifiedBeanOfType(applicationContext.getBeanFactory(), VoucherRepository.class, "memory");//applicationContext.getBean(VoucherRepository.class);
        /***
